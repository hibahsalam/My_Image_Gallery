...
function signs() {
	...
	with (document.zodiac.csign){
		if (x == 1 || x == -11) {value = "Unicorn";}
		if (x == 0) {value = "Mermaid";}
		if (x == 11 || x == -1) {value = "Fairy";}
		if (x == 10 || x == -2) {value = "Werewolf";}
		if (x == 9 || x == -3)  {value = "Vampire";}
		if (x == 8 || x == -4)  {value ="Sphinx";}
		if (x == 7 || x == -5)  {value = "Griffin";}
		if (x == 6 || x == -6)  {value = "Pixie";}
		if (x == 5 || x == -7)  {value = "Troll";}
		if (x == 4 || x == -8)  {value = "Phoenix";}
		if (x == 3 || x == -9)  {value = "Sea Serpent";}
		if (x == 2 || x == -10)  {value = "Imp";}  
